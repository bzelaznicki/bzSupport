...
export async function createRefreshToken(sql: Sql, args: CreateRefreshTokenArgs): Promise<void> {
    await sql.unsafe(createRefreshTokenQuery, [args.userId, args.token, args.expiresAt]);
}
...
export async function getRefreshToken(sql: Sql, args: GetRefreshTokenArgs): Promise<GetRefreshTokenRow | null> {
...
export const deleteUserRefreshTokensQuery = `-- name: DeleteUserRefreshTokens :exec
...
export async function deleteUserRefreshTokens(sql: Sql, args: DeleteUserRefreshTokensArgs): Promise<void> {
